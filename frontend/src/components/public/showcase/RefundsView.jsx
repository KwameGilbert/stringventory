            ...
            <tbody className="divide-y divide-slate-50">
               {[
                  ...
                  <tr key={i} className="hover:bg-slate-50/50 transition-colors group">
                     ...
                     <td className="px-6 py-6 text-sm font-bold text-slate-900 text-center">{item.customer}</td>
                     ...
                     <td className="px-6 py-6 text-sm font-bold text-slate-900 text-center">{item.amount}</td>
