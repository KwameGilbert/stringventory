    ...
    <div className="max-w-4xl mx-auto pb-8 animate-fade-in">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3">
            ...
            <span className="px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-sm font-mono font-medium">{id}</span>
        </div>
        <p className="text-gray-500 text-sm mt-1">Update supplier information</p>
      </div>
