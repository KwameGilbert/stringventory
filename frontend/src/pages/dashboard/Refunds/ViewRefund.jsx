    ...
    <div className="max-w-6xl mx-auto pb-12 animate-fade-in px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
            {/* Header Card */}
            <div className="bg-white rounded-xl p-8 border border-gray-100 shadow-sm relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <p className="text-gray-500 font-medium max-w-md">
                        Requested for order <Link to={`/dashboard/orders/${refund.orderId}`} className="text-blue-600 font-medium hover:underline">#{refund.order?.orderNumber || refund.orderId}</Link> on {formatDate(refund.createdAt)}
                    </p>
                </div>
            </div>
        ...
        <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="pt-6 border-t border-gray-100 space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-[11px] font-medium text-gray-500 tracking-tight truncate group-hover:text-gray-700">
            ...
            {/* Context Warning */}
            <div className="bg-amber-50 rounded-xl p-6 border border-amber-200 shadow-sm shadow-amber-900/5">
