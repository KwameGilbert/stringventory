        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 md:gap-3 py-2 md:py-2.5 px-3 md:px-4 rounded-lg md:rounded-xl transition-all relative group shrink-0 ${
      ...
      <div className="hidden md:block p-4 space-y-3 bg-slate-900/80 backdrop-blur-md border-t border-slate-800">
        ...
        <div className="bg-slate-800/60 rounded-[1.8rem] p-4 flex items-center justify-between group cursor-pointer border border-slate-700/30">
           <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-full bg-slate-700 border-2 border-slate-600 flex items-center justify-center text-xs font-black text-slate-300 shadow-inner">AA</div>
              <div className="flex flex-col text-left">
                 <span className="text-[11px] font-black text-white">Anthony Afriyie</span>
