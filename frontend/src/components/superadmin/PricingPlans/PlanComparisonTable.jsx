    ...
    <div className="space-y-8">
      ...
      <div className="overflow-hidden bg-white rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50">
              ...
              <tr className="bg-slate-900 text-white">
                ...
                <th className="px-8 py-6 relative">
                   <div className="absolute top-0 right-0 p-1">
                      <div className="bg-emerald-500 text-[8px] font-black px-2 py-0.5 rounded-bl-lg uppercase tracking-tighter">Popular</div>
                   </div>
              ...
              {comparisonData.map((cat, idx) => (
                <React.Fragment key={idx}>
                  <tr className="bg-slate-50/80">
                    <td colSpan="4" className="px-8 py-4 text-left font-black text-[10px] uppercase tracking-[0.2em] text-slate-400">
                      {cat.category}
                    </td>
                  </tr>
        ...
        <div className="bg-slate-900 px-8 py-4 flex items-center justify-between text-white/50">
           ...
           <p className="text-[10px] font-black uppercase tracking-widest">Pricing Strategy V2.4</p>
        </div>
      </div>
    </div>
  );
