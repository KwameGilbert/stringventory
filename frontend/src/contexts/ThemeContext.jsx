...
export const themes = {
  ...
  purple: {
    ...
    name: 'Purple',
    sidebarBg: 'bg-slate-900',
    logoGradient: 'bg-purple-500',
    logoIcon: 'text-white',
    activeMenuGradient: 'bg-purple-500',
    activeMenuShadow: '',
    menuHoverBg: 'hover:bg-slate-700/50',
    menuHoverText: 'group-hover:text-purple-400',
    profileGradient: 'bg-purple-500',
    ...
    bgTertiary: 'bg-purple-700',
    // New properties
    selectionBg: 'bg-purple-50',
    selectionText: 'text-purple-600',
    pageGradient: 'bg-gradient-to-br from-purple-50 via-fuchsia-50 to-pink-50',
    decorativeCircle1: 'bg-purple-200',
    decorativeCircle2: 'bg-fuchsia-200',
    decorativeCircle3: 'bg-pink-200',
    strengthStrong: 'bg-purple-500',
  },
};
